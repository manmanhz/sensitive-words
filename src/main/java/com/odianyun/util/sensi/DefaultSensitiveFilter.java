...
public class DefaultSensitiveFilter implements SensitiveFilter{
	 ...
	 */
	public DefaultSensitiveFilter(BufferedReader reader){
		try{
	...
	public DefaultSensitiveFilter(List<String> words) {
	...
	public Set<String> findWords(String sentence) {
		// 先转换为StringPointer
		StringPointer sp = new StringPointer(sentence);
